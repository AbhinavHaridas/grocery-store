    ...
    >
      <div style={{ display: "flex", justifyContent: "center" }}>
        <img
          src={image}
          style={{
            width: "18.556701030927837vh",
            height: "15.463917525773196vh",
            marginTop: "5vh",
          }}
          alt="images"
        />
      ...
      >
        <Link style={{ all: "unset" }} to="/categoryitems">
          <Button
            style={{
              width: "4.123711340206185vh",
              height: "4.123711340206185vh",
...
const Deals = ({ id, title, COLORS }) => {
  ...
  useEffect(() => {
    fetch(
      `http://localhost:8000/deals/get_specific_deal_items?deal_type_id=${id}`,
      { mode: "cors" }
    )
